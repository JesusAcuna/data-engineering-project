...
- 3.[Technologies](#3-technologies)
  ...
  - 3.2.[Alternative B - Local](#31-alternative-b---local)
...
- 6.[Instructions on how to replicate the project](#6-instructions-on-how-to-replicate-the-project)
  ...
  - 6.3.[VM instance connection configuration](#63-vm-instance-connecntion-configuration)
  - 6.4.[Setting up VM instance](#64-setting-up-instance)
...
- 8.[Alternative B - Cloud](#8-alternative-b---cloud)
  - 8.1.[Setting up Terraform ](#81-setting-up-terraform)
